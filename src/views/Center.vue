 ...
 * @LastEditors: Ares
 * @LastEditTime: 2020-08-20 14:10:54
...
<template>
  <div class="center">
    ...
    <div class="banner">
      <img
        src="http://hukaobang.caimaomeng.com/static/kaoshi/img/invitation.png"
        @click="goInvite()"
      />
    </div>
    <van-cell-group>
      <van-cell
        title="我的科目"
        icon="http://hukaobang.caimaomeng.com/static/kaoshi/img/subject.png"
        is-link
        to="subject"
      />
      <van-cell
        title="新增考试"
        icon="http://hukaobang.caimaomeng.com/static/kaoshi/img/add.png"
        is-link
        to="subject"
      />
      <van-cell
      ...
      <van-cell
        title="考试记录"
        icon="http://hukaobang.caimaomeng.com/static/kaoshi/img/-record.png"
        is-link
        to="record"
      />
      <van-cell
        title="我的财富"
        icon="http://hukaobang.caimaomeng.com/static/kaoshi/img/ware.png"
        is-link
        to="wealth"
      />
      <van-cell
        title="奖励细则"
        icon="http://hukaobang.caimaomeng.com/static/kaoshi/img/rule.png"
        is-link
        to="rule"
      />
    </van-cell-group>
...
export default {
  ...
  methods: {
    ...
    goInvite() {
      window.location.href = `${this.WR.base_url}/api/v1/inviteFriends?token=${this.token}`;
    },
  },
  components: {
    // HelloWorld
